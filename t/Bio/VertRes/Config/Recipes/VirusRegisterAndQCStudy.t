...
Bio::VertRes::Config::RegisterStudy->new(database => 'pathogen_virus_track', study_name => 'DDD',config_base => $destination_directory)->register_study_name();
...
ok( -e $destination_directory . '/viruses/qc/qc_DDD.conf', 'QC toplevel file with modified database' );
$text = read_file( $destination_directory . '/viruses/qc/qc_DDD.conf' );
$input_config_file = eval($text);
is_deeply($input_config_file,{
  'max_failures' => 3,
  'db' => {
  ...
  'log' => '/nfs/pathnfs01/log/viruses/qc_DDD.log',
  'root' => '/lustre/scratch108/pathogen/pathpipe/viruses/seq-pipelines',
  'prefix' => '_',
  'module' => 'VertRes::Pipelines::TrackQC_Fastq'
