...
ok( -e $destination_directory . '/my_database/qc/qc__ABC_study_EFG_ABC.conf', 'QC toplevel file' );
$text = read_file( $destination_directory . '/my_database/qc/qc__ABC_study_EFG_ABC.conf' );
...
ok( -e $destination_directory . '/my_database/qc/qc__ABC_study_EFG__Cat_DogABC.conf', 'QC toplevel file with species' );
$text = read_file( $destination_directory . '/my_database/qc/qc__ABC_study_EFG__Cat_DogABC.conf' );
...
is_deeply($input_config_file,{
  ...
  'log' => '/nfs/pathnfs01/log/my_database/qc__ABC_study_EFG__Cat_DogABC.log',
  'root' => '/lustre/scratch108/pathogen/pathpipe/my_database/seq-pipelines',
  'prefix' => '_',
  'module' => 'VertRes::Pipelines::TrackQC_Fastq'
