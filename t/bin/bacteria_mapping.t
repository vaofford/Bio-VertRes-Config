...
my %scripts_and_expected_files = (
    ...
    '-t study -i ZZZ -r ABC -m tophat' => [
        'command_line.log',
        'prokaryotes/import_cram/import_cram_global.conf',        'prokaryotes/mapping/mapping_ZZZ_ABC_tophat.conf',
        'prokaryotes/prokaryotes.ilm.studies',
        'prokaryotes/prokaryotes_import_cram_pipeline.conf', 'prokaryotes/prokaryotes_mapping_pipeline.conf',
            'prokaryotes/prokaryotes_stored_pipeline.conf',
                          'prokaryotes/stored/stored_global.conf',
    ...
    '-t study -i ZZZ -r ABC -m bowtie2' => [
        'command_line.log',
        'prokaryotes/import_cram/import_cram_global.conf',        'prokaryotes/mapping/mapping_ZZZ_ABC_bowtie2.conf',
        'prokaryotes/prokaryotes.ilm.studies',
        'prokaryotes/prokaryotes_import_cram_pipeline.conf', 'prokaryotes/prokaryotes_mapping_pipeline.conf',
           'prokaryotes/prokaryotes_stored_pipeline.conf',
                       'prokaryotes/stored/stored_global.conf',
