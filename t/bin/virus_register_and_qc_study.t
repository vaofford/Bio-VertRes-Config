...
my %scripts_and_expected_files = (
    ...
    '-t study -i ZZZ -r ABC' => [
        'command_line.log',                          'viruses/annotate_assembly/annotate_assembly_ZZZ.conf',
        'viruses/assembly/assembly_ZZZ_spades.conf', 'viruses/import/import_global.conf',
        'viruses/viruses.ilm.studies',               'viruses/viruses_annotate_assembly_pipeline.conf',
    ...
    '-t study -i ZZZ -r ABC -assembler velvet' => [
        'command_line.log',                          'viruses/annotate_assembly/annotate_assembly_ZZZ.conf',
        'viruses/assembly/assembly_ZZZ_velvet.conf', 'viruses/import/import_global.conf',
        'viruses/viruses.ilm.studies',               'viruses/viruses_annotate_assembly_pipeline.conf',
        'viruses/viruses_assembly_pipeline.conf',    'viruses/viruses_import_pipeline.conf',
        'viruses/viruses_qc_pipeline.conf',          'viruses/viruses_stored_pipeline.conf',
        'viruses/qc/qc_ZZZ.conf',                    'viruses/stored/stored_global.conf',
    ...
    '-t lane -i 1234_5#6 -r ABC' => [
        ...
        'viruses/stored/stored_global.conf',              'viruses/annotate_assembly/annotate_assembly_1234_5_6.conf',
        'viruses/assembly/assembly_1234_5_6_spades.conf', 'viruses/viruses_annotate_assembly_pipeline.conf',
    ...
    '-t library -i libname -r ABC' => [
        ...
        'viruses/stored/stored_global.conf',             'viruses/annotate_assembly/annotate_assembly_libname.conf',
        'viruses/assembly/assembly_libname_spades.conf', 'viruses/viruses_annotate_assembly_pipeline.conf',
        'viruses/viruses_assembly_pipeline.conf',
    ],
    '-t sample -i sample -r ABC' => [
        ...
        'viruses/stored/stored_global.conf',            'viruses/annotate_assembly/annotate_assembly_sample.conf',
        'viruses/assembly/assembly_sample_spades.conf', 'viruses/viruses_annotate_assembly_pipeline.conf',
        'viruses/viruses_assembly_pipeline.conf',
    ],
    '-t file -i t/data/lanes_file -r ABC' => [
        ...
        'viruses/annotate_assembly/annotate_assembly_1111_2222_3333_lane_name_another_lane_name_a_very_big_lane_name.conf',
    ...
    '-t study -i ZZZ -r ABC -s Staphylococcus_aureus' => [
        'command_line.log',
        'viruses/annotate_assembly/annotate_assembly_ZZZ_Staphylococcus_aureus.conf',
