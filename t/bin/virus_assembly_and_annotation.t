...
my %scripts_and_expected_files = (
    ...
    '-t lane -i 1234_5#6' => [
        'command_line.log',
        'viruses/annotate_assembly/annotate_assembly_1234_5_6.conf',
    ...
    '-t library -i libname' => [
        'command_line.log',
        'viruses/annotate_assembly/annotate_assembly_libname.conf',
    ...
    '-t sample -i sample' => [
        'command_line.log',
        'viruses/annotate_assembly/annotate_assembly_sample.conf',
