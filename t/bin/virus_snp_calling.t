...
my %scripts_and_expected_files = (
    ...
    '-t study -i ZZZ -r ABC' => [
        ...
        'viruses/mapping/mapping_ZZZ_ABC_smalt.conf', 'viruses/viruses.ilm.studies',
        ...
        'viruses/permissions/permissions_ZZZ.conf',   'viruses/viruses_permissions_pipeline.conf',
    ...
    '-t lane -i 1234_5#6 -r ABC' => [
        ...
        'viruses/viruses_stored_pipeline.conf',            'viruses/snps/snps_1234_5_6_ABC.conf',
    ...
    '-t library -i libname -r ABC' => [
        ...
        'viruses/viruses_mapping_pipeline.conf',          'viruses/viruses_snps_pipeline.conf',
        'viruses/viruses_stored_pipeline.conf',           'viruses/snps/snps_libname_ABC.conf',
    ...
    '-t sample -i sample -r ABC' => [
        ...
        'viruses/viruses_mapping_pipeline.conf',         'viruses/viruses_snps_pipeline.conf',
        'viruses/viruses_stored_pipeline.conf',          'viruses/snps/snps_sample_ABC.conf',
    ...
    '-t study -i ZZZ -r ABC -s Staphylococcus_aureus' => [
        ...
        'viruses/viruses_stored_pipeline.conf',                             'viruses/snps/snps_ZZZ_Staphylococcus_aureus_ABC.conf',
        'viruses/stored/stored_global.conf',                                'viruses/viruses_permissions_pipeline.conf',
    ],
    '-t study -i ZZZ -r ABC -m bwa' => [
        'command_line.log',                          'viruses/import_cram/import_cram_global.conf',
        'viruses/mapping/mapping_ZZZ_ABC_bwa.conf',  'viruses/viruses.ilm.studies',
        'viruses/viruses_import_cram_pipeline.conf', 'viruses/viruses_mapping_pipeline.conf',
        'viruses/viruses_snps_pipeline.conf',        'viruses/viruses_stored_pipeline.conf',
        'viruses/viruses_permissions_pipeline.conf', 'viruses/permissions/permissions_ZZZ.conf',
        'viruses/snps/snps_ZZZ_ABC.conf',            'viruses/stored/stored_global.conf',
    ],
    '-t study -i ZZZ -r ABC -m ssaha2' => [
        'command_line.log',                           'viruses/import_cram/import_cram_global.conf',
        'viruses/mapping/mapping_ZZZ_ABC_ssaha.conf', 'viruses/viruses.ilm.studies',
        'viruses/viruses_import_cram_pipeline.conf',  'viruses/viruses_mapping_pipeline.conf',
        'viruses/viruses_snps_pipeline.conf',         'viruses/viruses_stored_pipeline.conf',
        'viruses/viruses_permissions_pipeline.conf',  'viruses/permissions/permissions_ZZZ.conf',
        'viruses/snps/snps_ZZZ_ABC.conf',             'viruses/stored/stored_global.conf',
    ...
    '-t study -i ZZZ -r ABC -m stampy' => [
        'command_line.log',                            'viruses/import_cram/import_cram_global.conf',
        'viruses/mapping/mapping_ZZZ_ABC_stampy.conf', 'viruses/viruses.ilm.studies',
        'viruses/viruses_import_cram_pipeline.conf',   'viruses/viruses_mapping_pipeline.conf',
        'viruses/viruses_snps_pipeline.conf',          'viruses/viruses_stored_pipeline.conf',
        'viruses/viruses_permissions_pipeline.conf',   'viruses/permissions/permissions_ZZZ.conf',
        'viruses/snps/snps_ZZZ_ABC.conf',              'viruses/stored/stored_global.conf',
    ...
    '-t study -i ZZZ -r ABC -m bowtie2' => [
        'command_line.log',                             'viruses/import_cram/import_cram_global.conf',
        'viruses/mapping/mapping_ZZZ_ABC_bowtie2.conf', 'viruses/viruses.ilm.studies',
        'viruses/viruses_import_cram_pipeline.conf',    'viruses/viruses_mapping_pipeline.conf',
        'viruses/viruses_snps_pipeline.conf',           'viruses/viruses_stored_pipeline.conf',
        'viruses/viruses_permissions_pipeline.conf',    'viruses/permissions/permissions_ZZZ.conf',
        'viruses/snps/snps_ZZZ_ABC.conf',               'viruses/stored/stored_global.conf',
