package Bio::VertRes::Config::Recipes::BacteriaSnpCallingUsingMaq;
# ABSTRACT: Standard snp calling pipeline for bacteria

=head1 SYNOPSIS

Standard snp calling pipeline for bacteria. Register study, QC, map with Maq, snp call
   use Bio::VertRes::Config::Recipes::BacteriaSnpCallingUsingMaq;
   
   my $obj = Bio::VertRes::Config::Recipes::BacteriaSnpCallingUsingMaq->new( 
     database => 'abc', 
...
override '_pipeline_configs' => sub {
    ...
    push(
        @pipeline_configs,
        Bio::VertRes::Config::Pipelines::MaqMapping->new(
            database                       => $self->database,
            config_base                    => $self->config_base,
            overwrite_existing_config_file => $self->overwrite_existing_config_file,
            limits                         => $self->limits,
