...
has '_adapters_file'       => ( is => 'ro', isa => 'Str',  default => '/lustre/scratch118/infgen/pathogen/pathpipe/usr/share/solexa-adapters.fasta' );

has '_error_correct'        => ( is => 'rw', isa => 'Bool', default => 0 );
has '_normalise'            => ( is => 'rw', isa => 'Bool', default => 0 );
has '_remove_adapters'      => ( is => 'rw', isa => 'Bool', default => 0 );
has '_adapter_removal_tool' => ( is => 'rw', isa => 'Str',  default => 'iva' );
...
override 'to_hash' => sub {
    ...
    $output_hash->{data}{primers_file}     = $self->_primers_file if defined $self->_primers_file;
    ...
    $output_hash->{data}{remove_adapters}  = $self->_remove_adapters;
