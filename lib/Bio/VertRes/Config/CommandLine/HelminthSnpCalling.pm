...
helminth_snp_calling -t study -i 1234 -r "Schistosoma_mansoni_v5" -d my_database -c /path/to/my/configs

# Map and SNP call a study in named database specifying root and log base directories
helminth_snp_calling -t study -i 1234 -r "Schistosoma_mansoni_v5" -d my_database -root /path/to/root -log /path/to/log

# Map and SNP call a study in named database specifying a file with database connection details
helminth_snp_calling -t study -i 1234 -r "Schistosoma_mansoni_v5" -d my_database -db_file /path/to/connect/file
